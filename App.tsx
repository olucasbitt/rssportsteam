...
{/* Borda externa */}
<div className="absolute -inset-4 border border-racingYellow/20 "></div>

{/* Caixa principal */}
<div className="relative z-10 overflow-hidden bg-deepBlack border-b-4 border-racingYellow  shadow-2xl aspect-[4/3]">
<img 
  src="/imagens/carreta2.jpg" 
  alt="RSSports Team em corrida" 
  className="w-full h-full object-cover scale-105  group-hover:scale-110 transition-all duration-700 brightness-75 contrast-110"
/>

<div className="absolute inset-0 bg-gradient-to-t from-deepBlack/60 via-transparent to-transparent"></div>

{/* Badge */}
<div className="absolute bottom-6 left-6">
  <div className="bg-racingYellow p-4 skew-box shadow-xl">
